...
/* harmony import */ var _modules_Test__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/Test */ "./src/modules/Test.js");
 // Our modules / classes
...
const searchMagic = new _modules_Search__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
const TestWork = new _modules_Test__WEBPACK_IMPORTED_MODULE_7__["default"]();
...
class MyNotes {
  ...
  makeNoteReadOnly(thisNote) {
    ...
    thisNote.find('.note-title-field, .note-body-field').attr('readonly', 'reayonly').removeClass('note-active-field');
  ...
  createNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      error: response => {
        if (response.responseText == "Your are Limited.") {
